...
import com.example.proyecto_1_evaluacion_android.databinding.FragmentRestauranteeBinding;

import java.util.List;

public class MyrestauranteeRecyclerViewAdapter extends RecyclerView.Adapter<MyrestauranteeRecyclerViewAdapter.ViewHolder> {

    private final List<Restaurante> mValues;
    // 5 - Rescatamos el contexto desde el fragment
    private Context ctx;

    public MyrestauranteeRecyclerViewAdapter(Context context, List<Restaurante> items) {
        ctx = context;
        mValues = items;
    }
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new ViewHolder(FragmentRestauranteeBinding.inflate(LayoutInflater.from(parent.getContext()), parent, false));
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(FragmentRestauranteeBinding binding) {
